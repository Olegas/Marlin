...
#define STRING_CONFIG_H_AUTHOR "Olegas <oleg@elifantiev.ru>" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 100, 150 }  // default steps per unit for Kossel (GT2, 20 tooth)
...
#define MANUAL_Z_HOME_POS 282.0 // Distance between the nozzle to printbed after homing
